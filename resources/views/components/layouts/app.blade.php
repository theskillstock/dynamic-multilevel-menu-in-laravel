...
<head>
    ...
    <meta name="author" content="CodeWithZubi">
    <meta name="robots" content="">
    <meta name="keywords" content="tajj Associates">
    <meta name="description" content="Tajj Associates">
    <meta property="og:title" content="Tajj Associates">
    <meta property="og:description" content="Tajj Associates">
    <meta property="og:image" content="https://codewithzubi.com/uploads/settings/codewithzubi.png">
    ...
    <!-- Page Title -->
    <title>@yield('page-title') - CodeWithZubi</title>
    ...
    <style>
        ...
        /* sidebar design management */
        .dlabnav .metismenu>li.mm-active>a {
            color: #42A5FE !important;
            background: #cfe2f6 !important;
        }

        [data-sidebar-style="full"][data-layout="vertical"] .dlabnav .metismenu>li>a:before {
            background: #42A5FE !important;
        }
        ...
        .btn-primary {
            background-color: #42A5FE !important;
        ...
        .dataTables_paginate .previous i {
            color: #42A5FE !important;
        }

        .dataTables_paginate .next i {
            color: #42A5FE !important;
        }
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{ route('dashboard') }}" class="brand-logo">
                ...
                <svg class="logo-abbr" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    stroke="">
                ...
                <p style="color: #42A5FE" class="brand-title">CWZ</p>
            </a>
    ...
    <script>
        $(document).ready(function() {
            $('#toggleFormBtn').click(function() {
                ...
                var belowSection = $('.below-section');
                var toggleIcon = $('#toggleIcon i');

                if (formSection.hasClass('show')) {
                    formSection.removeClass('show');
                    belowSection.css('margin-top', '0');
                    $(this).text('Advance Search +');
                    toggleIcon.attr('data-feather', 'arrow-down'); // Change icon to down
                } else {
                    formSection.addClass('show');
                    belowSection.css('margin-top', formSection.outerHeight() + 'px');
                    $(this).text('Advance Search -');
                    toggleIcon.attr('data-feather', 'arrow-up'); // Change icon to up
                }

                // Re-initialize Feather icons to apply the new icon
                feather.replace();
            });
        });
    </script>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button"
                        style="background-color:#dc3545; color:white; border-radius:15%; padding:2%" class="btn"
                        onclick="confirmDelete()">Yes</button>
                    <button type="button"
                        style="background-color:#4faad5; color:white; border-radius:15%; padding:2%" class="btn"
                        type="button" data-bs-dismiss="modal" aria-label="Close">No</button>
                </div>
            </div>
        </div>
    </div>
